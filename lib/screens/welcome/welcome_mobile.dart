          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InputField(controller: emailController, label: "Enter Email", isPassword: false, icon: Icon(Icons.person_outline_rounded),),
                SizedBox(height: 20,),
                InputField(controller: passwordController, label: "Enter Password", isPassword: true, icon: Icon(Icons.lock_open_outlined),),
                SizedBox(height: 20,),
                Obx(
